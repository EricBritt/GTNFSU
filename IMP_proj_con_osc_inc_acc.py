...
def numapprox(r, L, e):
    ...
    while z < r:
        ...
        u = (((1-h**2/6)*h**2*Gfunc(z, L, e)+2)*utemp+(h**4/12*Gfunc((z-h), L, e)-1)*ubef)/(1-h**4/12*Gfunc((z+h), L, e))
        ubef = utemp
        y.append(u**2)
        z = z + h
    return y
...
def EvR(maxR):
    ...
    plot(xl, l0gRs1, label = "fit n = 0", color = "b")

    scatter(xl, l0gRs2, label = "n = 2", color = "g")
    plot(xl, l0gRs2, color = "g")
    
    scatter(xl, l0gRs3, label = "n = 4", color = "r")
    plot(xl, l0gRs3, color = "b")
    ...
    plot(xl, l1gRs1, label = "fit n = 0", color = "b")

    scatter(xl, l1gRs2, label = "n = 2", color = "g")
    plot(xl, l1gRs2, label = "fit n = 0", color = "b")

    scatter(xl, l1gRs3, label = "n = 4", color = "r")
    plot(xl, l1gRs3, label = "fit n = 0", color = "b")
    ...
    plot(xl, l2gRs1, label = "fit n = 0", color = "b")

    scatter(xl, l2gRs2, label = "n = 2", color = "g")
    plot(xl, l2gRs2, label = "fit ", color = "g")

    scatter(xl, l2gRs3, label = "n = 4", color = "r")
    plot(xl, l2gRs3, label = "fit n = 0", color = "r")
